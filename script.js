...
(() => {
  const translations = {
    es: {
      ...
      servicesKicker:"Lo que ofrecemos", servicesTitle:"Una experiencia cuidada, de principio a fin.", servicesIntro:"Cada historia es distinta. Por eso adaptamos la cobertura a lo que ustedes necesitan, manteniendo siempre una mirada natural, elegante y atenta a los detalles.", servicesCta:"Solicitar información →",
      svcCoverageTitle:"Cobertura personalizada", svcCoverageText:"El tiempo y la atención se ajustan a su celebración, sus prioridades y los momentos que más importan.",
    ...
    en: {
      ...
      servicesKicker:"What we offer", servicesTitle:"A thoughtful experience, from beginning to end.", servicesIntro:"Every story is different. We tailor the coverage to what you need while keeping our approach natural, elegant and attentive to every detail.", servicesCta:"Request information →",
      svcCoverageTitle:"Personalized coverage", svcCoverageText:"Time and attention are tailored to your celebration, your priorities and the moments that matter most.",
