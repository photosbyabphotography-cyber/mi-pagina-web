...
(() => {
  const translations = {
    es: {
      ...
      portfolioKicker:"Portafolio", portfolioTitle:"Historias organizadas por celebración.", weddingCategoryKicker:"Portafolio", weddingCategoryTitle:"Bodas", weddingCategoryLink:"Explorar galería →", quinceCategoryLink:"Explorar galería →", quinceCategoryKicker:"Portafolio", quinceCategoryTitle:"Quinceañeras", sessionsCategoryKicker:"Portafolio", sessionsCategoryTitle:"Sesiones", sessionsCategoryLink:"Explorar galería →", eventsCategoryKicker:"Portafolio", eventsCategoryTitle:"Eventos", eventsCategoryLink:"Explorar galería →",
      servicesKicker:"Lo que ofrecemos", servicesTitle:"Una experiencia cuidada, de principio a fin.", servicesIntro:"Ofrecemos paquetes establecidos con tiempos de cobertura y entregables claros, manteniendo siempre una mirada natural, elegante y atenta a cada detalle.", servicesCta:"Solicitar información →",
      svcCoverageTitle:"Paquetes claramente definidos", svcCoverageText:"Elige entre nuestros paquetes establecidos según las horas de cobertura que necesites. Cada opción indica lo que incluye, la cantidad mínima de fotografías y la forma de entrega.",
      svcGuidanceTitle:"Orientación cercana", svcGuidanceText:"Les ayudamos con horarios, locaciones y una dirección natural para que se sientan cómodos frente a la cámara.",
      svcDeliveryTitle:"Edición y galería digital", svcDeliveryText:"Cada fotografía se edita cuidadosamente y se entrega en una galería privada, elegante y fácil de compartir.",
      experienceKicker:"Cómo trabajamos", experienceTitle:"Simple, claro y sin complicaciones.", experienceIntro:"Queremos que disfruten la experiencia tanto como el resultado. Nosotros guiamos el proceso; ustedes viven el momento.",
      stepConsultTitle:"Conversemos", stepConsultText:"Nos cuentan su fecha, lugar y la idea que tienen en mente.", stepPlanTitle:"Planeamos", stepPlanText:"Definimos juntos lo necesario para que el día fluya con calma.", stepEnjoyTitle:"Disfruten", stepEnjoyText:"Durante la sesión o celebración, ustedes viven el momento y nosotros lo documentamos.",
    ...
    en: {
      ...
      portfolioKicker:"Portfolio", portfolioTitle:"Stories organized by celebration.", weddingCategoryKicker:"Portfolio", weddingCategoryTitle:"Weddings", weddingCategoryLink:"Explore gallery →", quinceCategoryLink:"Explore gallery →", quinceCategoryKicker:"Portfolio", quinceCategoryTitle:"Quinceañeras", sessionsCategoryKicker:"Portfolio", sessionsCategoryTitle:"Sessions", sessionsCategoryLink:"Explore gallery →", eventsCategoryKicker:"Portfolio", eventsCategoryTitle:"Events", eventsCategoryLink:"Explore gallery →",
      servicesKicker:"What we offer", servicesTitle:"A thoughtful experience, from beginning to end.", servicesIntro:"We offer established packages with clear coverage times and deliverables, while keeping our approach natural, elegant and attentive to every detail.", servicesCta:"Request information →",
      svcCoverageTitle:"Clearly defined packages", svcCoverageText:"Choose from our established packages based on the coverage time you need. Each option clearly states what is included, the minimum number of photographs, and the delivery format.",
      svcGuidanceTitle:"Thoughtful guidance", svcGuidanceText:"We help with timing, locations and natural direction so you can feel comfortable in front of the camera.",
      svcDeliveryTitle:"Editing and digital gallery", svcDeliveryText:"Every photograph is carefully edited and delivered in a private, elegant gallery that is easy to share.",
      experienceKicker:"How it works", experienceTitle:"Simple, clear and effortless.", experienceIntro:"We want you to enjoy the experience as much as the final photographs. We guide the process; you live the moment.",
      stepConsultTitle:"Let’s talk", stepConsultText:"Tell us your date, location and what you have in mind.", stepPlanTitle:"We plan", stepPlanText:"Together, we define what is needed so everything flows calmly.", stepEnjoyTitle:"Enjoy", stepEnjoyText:"During your session or celebration, you live the moment while we document it.",
